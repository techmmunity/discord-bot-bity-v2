...
export const sendSocioReminder = async (
	...
	Se você tiver interesse e achar que é qualificado, seja pelas coisas que eu citei ou por alguma outra skill sua, manda uma DM pra mim (<@${UsersEnum.RAZAL}>) e bora trocar uma ideia a respeito, eu posso te apresentar mais sobre a Tech, sobre o que já temos construido e o que planejo pro futuro.`);
};
